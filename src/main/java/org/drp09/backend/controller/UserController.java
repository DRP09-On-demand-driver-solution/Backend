...
public class UserController {
  ...
  public Result<Void> register(String username, String gender, String password, String rePassword, String phone, String trueName, String cardNumber, String cvv) {
    User user = userService.findByUsername(username);

    if (user == null) {
      if (password.equals(rePassword)) {
        userService.register(username, gender, password, phone, trueName, cardNumber, cvv);
